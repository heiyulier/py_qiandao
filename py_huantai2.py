...
#获取个人信息，判断登录状态
def get_infouser(HT_cookies2,HT_UA2):
    flag = False
    global session
...
def main(event, context):
    ...
    global client
    global HT_cookies2
    global HT_UserAgent2
    
    HT_cookies2 = os.environ.get('HT_cookies2')
    HT_UserAgent2 = os.environ.get('HT_UserAgent2')
    #print(HT_cookies2,HT_UserAgent2)
    client = get_infouser(HT_cookies2,HT_UserAgent2)
