...
#获取个人信息，判断登录状态
def get_infouser(HT_cookies3,HT_UA3):
    flag = False
    global session
...
def main(event, context):
    ...
    global client
    global HT_cookies3
    global HT_UserAgent3
    
    HT_cookies3 = os.environ.get('HT_cookies3')
    HT_UserAgent3 = os.environ.get('HT_UserAgent3')
    #print(HT_cookies3,HT_UserAgent3)
    client = get_infouser(HT_cookies3,HT_UserAgent3)
