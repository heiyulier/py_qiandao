...
#获取个人信息，判断登录状态
def get_infouser(HT_cookies1,HT_UA1):
    flag = False
    global session
...
def main(event, context):
    ...
    global client
    global HT_cookies1
    global HT_UserAgent1
    
    HT_cookies1 = os.environ.get('HT_cookies1')
    HT_UserAgent1 = os.environ.get('HT_UserAgent1')
    #print(HT_cookies1,HT_UserAgent1)
    client = get_infouser(HT_cookies1,HT_UserAgent1)
